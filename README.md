# The Movie Index - A Movie Catalog (Microverse React Module Capstone)

![Microverse](https://img.shields.io/badge/-Microverse-007bff?style=for-the-badge)

## Description
The Movie Index application is a React Capstone project of Microverse. This application fetches API data from TMDB[https://www.themoviedb.org/] and displays them as catalog.
...
## Live Demo
[TheMovieIndex live demo]()

<!-- ## App Screenshot
| |
|:-------------------------:|
| <img alt="TheMovieIndex App" src=""> <p align="center"><b>TheMovieIndex</b><p>| -->
...
1. - In your terminal run the command `git clone https://github.com/rloterh/TheMovieIndex.git`
...
Feel free to check the [issues page](https://github.com/rloterh/TheMovieIndex/issues).
